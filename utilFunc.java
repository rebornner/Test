...
public class utilFunc {
    ...
    public static String hexStringToString(String hexString, int encodeType) {
        ...
        for (int i = 0; i < max; i++) {
            char c = (char) utilFunc.hexStringToAlgorism(hexString
    ...
    public static byte[] hexStringToByte(String hex) {
        ...
        String binarys = utilFunc.hexStringToBinary(hex);
        for (int i = 0; i < max; i++) {
            bytes[i] = (byte) utilFunc.binaryToAlgorism(binarys.substring(
                    i * 8 + 1, (i + 1) * 8));
